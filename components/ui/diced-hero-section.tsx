...
export const DicedHeroSection: React.FC<DicedHeroSectionProps> = ({
  ...
  const fallbackSlides: SlideContent[] = [
    { title: "Slide 1", image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='800'></svg>" },
    { title: "Slide 2", image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='800'></svg>" },
    { title: "Slide 3", image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='800'></svg>" },
    { title: "Slide 4", image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='800'></svg>" },
  ];

  // Keep exactly 4 tiles; repeat safely if fewer were passed.
  const baseSlides = slides.length > 0 ? slides : fallbackSlides;
  const safeSlides =
    baseSlides.length >= 4
      ? baseSlides
      : [...baseSlides, ...baseSlides, ...baseSlides, ...baseSlides].slice(0, 4);
  const orderedSlides = [safeSlides[3], safeSlides[2], safeSlides[1], safeSlides[0]];
            ...
            style={{
              ...
              margin: isMobile
                ...
                : isRTLCheck(mainText)
                  ...
                  : "1.125rem 0 1.875rem",
              alignSelf: isMobile ? "center" : isRTLCheck(mainText) ? "flex-end" : "flex-start",
            }}
          />
          <motion.p
            initial={{ opacity: 0, y: 20 }}
        ...
        >
          {orderedSlides.map((slide, index) => (
            ...
            >
              <img
                src={slide?.image ?? ""}
                alt={slide?.title ?? "Mission slide image"}
